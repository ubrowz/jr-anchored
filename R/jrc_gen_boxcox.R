...
message(" ")
message("✅ Box-Cox-Transformable Dataset Generated")
message("   version: 1.0, author: Joep Rous")
message("   ========================================")
message(paste("   n:                  ", n))
message(paste("   shape (Weibull):    ", shape_value))
message(paste("   scale (Weibull):    ", scale_value))
